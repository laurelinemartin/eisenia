...
\section{Utilisation d'un périphérique amovible}
	La plupart du temps, votre ordinateur reconnaîtra automatiquement votre périphérique.
	Il apparaitra alors dans la liste de gauche de votre gestionnaire de fichier
