...
\chapter{Mises à jour}\label{sec:maj}
	...
	\section{Pourquoi faire les mises à jour ?}\label{sec:maj_pourquoi}
		De manière globale, les mises à jour permettent à une application, un logiciel, un système, de corriger certaines erreurs, d'ajouter de nouvelles fonctionnalités ou bien de réparer certaines failles de sécurité.
