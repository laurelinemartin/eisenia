...
\chapter{Bonnes pratiques}
	...
	\section{Sécurité sur internet}
		Internet est une porte ouverte sur beaucoup de connaissance partagée entre tous les utilisateurs.
		Cette outil donne accès à beaucoup d'informations et ce, en très peu de temps.
		Mais si internet est 
