...
\section{La Logithèque de Linux Mint}\label{sec:logitheque}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{include/logitheque.png}
...
\section{Exemple de recherche dans la logithèque}\label{sec:exlogitheque}
	...
	Pour cela, nous allons prendre l'exemple du logiciel VLC.
	...
	Pour commencer, assurez-vous de bien être connecté à Internet puis ouvrez la Logithèque.
	Cela peut prendre quelques secondes à de chargement.
	...
	Le détail du logiciel s'affiche.
	On y retrouve une description, des captures d'écrans et les avis d'autres utilisateurs.
	Pour installer ce logiciel sur votre ordinateur, cliquez sur le bouton vert "\texttt{Installation}" situé en haut à droite.
	\begin{figure}[h]
		\centering
		\includegraphics[width=.8\textwidth]{include/vlc2.png}
		\caption{Détails du logiciel "\textit{VLC}"}
		\label{fig:vlc2}
	\end{figure}\par
	Une barre de chargement s'affiche alors à la place du bouton (voir la Captrure d'écran \ref{fig:vlc3}.
	Cela indique que l'installation du logiciel est en cours.
	Une fois l'installation terminée, les boutons "\texttt{Lancer}" et "\texttt{Supprimer}" apparaissent (voir la Captrure d'écran \ref{fig:vlc4}=.
	Vous pouvez cliquer sur "\texttt{Lancer}" pour démarrer l'application.
	Le bouton "\texttt{Suprimmer}" vous permet de désinstaller l'application.
	Vous pouvez aussi retrouver les applications et logiciels que vous téléchargés directement dans le Menu de Linux (voir la Section \ref{sec:menu}) en tapant son nom dans la barre de recherche.
	\begin{figure}[h]
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{include/vlc3.png}
			\caption{\textit{VLC} en cours d'installation}
			\label{fig:vlc3}
		\end{subfigure}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{include/vlc3.png}
			\caption{\textit{VLC} installé sur l'ordinateur}
			\label{fig:vlc4}
		\end{subfigure}
		\caption{Installation du logiciel \textit{VLC}}
		\label{fig:vlc3_4}
	\end{figure}\par
	Félicitations, vous venez d'installer votre premier logiciel !
...
\chapter{Mises à jour}\label{sec:maj}
	...
	\section{Comment faire les mises à jour}
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=.6\textwidth]{include/maj_accueil.png}
			...
			\begin{figure}[h]
				...
				\end{subfigure}
				\caption{Effectuer les mises à jour}
				\label{fig:majSelectInstall}
			\end{figure}
			\item Les mises à jour peuvent prendre du temps, ne fermez pas la fenêtre de chargement pendant ce temps.
		\end{enumerate}
		Félicitations ! Votre système et vos logiciels sont à jour !
...
Si vous rencontrez un problème avec votre ordinateur Linux Mint, la solution se trouve sûrement sur les forums :\newline
\href{https://forum-francophone-linuxmint.fr/}{https://forum-francophone-linuxmint.fr/} (Français)\newline
\href{https://forum.ubuntu-fr.org/}{https://forum.ubuntu-fr.org/} (Français)\newline
Vous pouvez aussi taper votre problème dans votre moteur de recherche.
Beaucoup d'internautes ont rédigé des solutions.\par
Si vous rechercher un logiciel, nous vous conseillez vivement de consulter \href{https://framalibre.org/}{https://framalibre.org/} qui répertorie beaucoup de logiciels libres (attention, tous les logiciels ne sont pas compatibles avec Linux).
